...
CREATE TABLE `t_service` (
  ...
  `division` varchar(32) NOT NULL COMMENT 'for example 101',
  `node` varchar(128) NOT NULL COMMENT 'for example 192.168.1.10',
  `service` varchar(64) NOT NULL COMMENT 'for example app.globby.notify',
  `service_ip` varchar(256) NOT NULL COMMENT 'intranet ip for globby, or internet ip for gconnd',
