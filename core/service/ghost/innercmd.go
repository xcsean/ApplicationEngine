...
const (
	...
	innerCmdDebug             = 105
	innerCmdBindSession       = 106
	innerCmdUnbindSession     = 107
	innerCmdVMStreamInitFault = 111
	innerCmdVMStreamSendFault = 112
	innerCmdVMStreamRecvFault = 113
	innerCmdVMStreamRecvPkt   = 114
