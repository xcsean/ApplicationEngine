...
type serviceGroup struct {
	array  []*svc.RegistryServiceConfig
	cursor uint32
}

// serviceAll contains service-groups which belong to various type
//  type is the map key generated by svc.MakeLookupKey
...
func (sa *serviceAll) fillNewer(newer map[string]*serviceGroup, key string,
	serviceList *list.List, serverMap map[string]*svc.RegistryServerConfig) {
	sa.lock.RLock()
...
func (sa *serviceAll) replace(serverMap map[string]*svc.RegistryServerConfig,
